...
public class User {
    ...
    public User(Long id, String name, String username, String email, String password, Boolean status, boolean active, String otp, LocalDateTime otpGeneratedTime, String avatar, Set<Role> roles) {
        this.id = id;
        this.name = name;
